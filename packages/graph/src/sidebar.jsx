...
function srcsFor() {
 return [{type:'Generated sample',label:'Synthetic data generator',url:'https://github.com/shaylazheng/investment-analyst-dashboard-public/blob/main/demo/data.js',truth:false}];
}
const methodFor = (k, intel, graphDate) => (k === "fund"
  ? { m: "Generated sample financial data", asOf: graphDate }
  : { m: "Generated narrative for the public demonstration", asOf: intel?.asOf });
